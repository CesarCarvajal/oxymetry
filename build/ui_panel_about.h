...
public:
    ...
    void retranslateUi(QDialog *PanelAbout)
    {
        ...
        label_title->setText(QApplication::translate("PanelAbout", "Oxymetry 0.4.2", Q_NULLPTR));
        ...
        plainTextEdit_changelog->setPlainText(QApplication::translate("PanelAbout", "Version 0.4.2: (08.10.2017)\n"
"\n"

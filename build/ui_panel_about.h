...
public:
    ...
    void retranslateUi(QDialog *PanelAbout)
    {
        ...
        label_title->setText(QApplication::translate("PanelAbout", "Oxymetry 0.3.0", Q_NULLPTR));
        ...
        plainTextEdit_changelog->setPlainText(QApplication::translate("PanelAbout", "Version 0.3.0: (29.09.2017)\n"
"\n"
...
"\n"
"* U"
                        "pdated AvaSpec library to version 9.6.0.0\n"
"\n"
...
"+ Additional information (dynamic dark corre"
                        "ction enabled, time and date, ...) is now stored within the saved spectra\n"
"\n"
"Version 0.2:\n"
"\n"
"Initial release", Q_NULLPTR));
        ...
        plainTextEdit_contributors->setPlainText(QApplication::translate("PanelAbout", "Isabeau Dibbern, Torben Kruse, Benjamin Redmer", Q_NULLPTR));

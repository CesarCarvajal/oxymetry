/****************************************************************************
** Meta object code from reading C++ file 'panel_item.h'
**
...
#error "The header file 'panel_item.h' doesn't include <QObject>."
...
void *PanelItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PanelItem.stringdata0))
        return static_cast<void*>(const_cast< PanelItem*>(this));
